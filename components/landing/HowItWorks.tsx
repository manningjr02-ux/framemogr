...
export default function HowItWorks() {
  return (
    <section className="relative py-20 sm:py-28 bg-zinc-900/20">
      <Container>
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-3 sm:gap-8">
          {STEPS.map(({ icon: Icon, title, description }) => (
            <div
              key={title}
              className="card-hover flex flex-col rounded-3xl border border-white/10 bg-white/5 p-8 shadow-lg transition-colors hover:border-cyan-500/20"
            >
